...
public enum Errors {
    ...
    INVALID_TOOL_CONFIGURATION("701192", "AI:ERROR_INVALID_TOOL_CONFIGURATION"),
    AGENT_ID_NOT_PROVIDED("701193", "AI:ERROR_AGENT_ID_NOT_PROVIDED"),
    MEMORY_CONFIG_KEY_NOT_FOUND("701194", "AI:ERROR_MEMORY_CONNECTION_NOT_PROVIDED"),
    SESSION_ID_NOT_FOUND("701195", "AI:ERROR_SESSION_ID_NOT_PROVIDED");
