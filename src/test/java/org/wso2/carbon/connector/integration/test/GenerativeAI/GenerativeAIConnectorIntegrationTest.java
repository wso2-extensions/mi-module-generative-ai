...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.GenerativeAI;
 ...
 */
public class GenerativeAIConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "GenerativeAI test case")
